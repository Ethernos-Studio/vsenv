...
# vsenv create my\_project

# 

# \# 启动实例

# vsenv start my\_project

# 

# \# 停止实例

# vsenv stop my\_project

# 

# \# 完全移除实例

# vsenv remove my\_project
...
# vsenv create my\_project --lang cn
...
# 1\. 创建实例：`vsenv create my\_project`

# 2\. 下载 VS Code 离线包（ZIP格式）

# 3\. 将离线包解压到 `%USERPROFILE%\\.vsenv\\my\_project\\vscode\\`

# 4\. 启动实例：`vsenv start my\_project`
